...
local c = Clipper()
c:AddPaths(subj, ClipperLib.PathType.Subject, false)
c:AddPaths(clip, ClipperLib.PathType.Clip, false)
local solution = c:ClipPaths(ClipperLib.ClipType.Intersection, ClipperLib.FillRule.EvenOdd)
